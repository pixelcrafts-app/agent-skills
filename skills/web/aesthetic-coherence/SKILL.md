...
Detection is a signal-scoring pass (Steps 1–3) — no rule-by-rule equivalent, runs here. Spec compliance (does the detected aesthetic meet the aesthetic-coherence rules?) is verified in Step 4 using a rule-walking audit workflow.
