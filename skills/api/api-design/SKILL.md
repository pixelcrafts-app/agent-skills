---
name: api-design
description: REST API design principles — resource naming, HTTP semantics, status codes, pagination, filtering, error responses, auth, rate limiting, and versioning. Framework-agnostic.
origin: ECC
---
