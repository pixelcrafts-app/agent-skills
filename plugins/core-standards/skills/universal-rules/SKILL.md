...
description: Apply when editing any code file. Universal rules that apply regardless of stack. Referenced by section heading — e.g. universal-rules:security, universal-rules:testing.
---
