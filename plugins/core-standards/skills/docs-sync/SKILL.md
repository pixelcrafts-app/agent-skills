...
5. **Skills catalog** (`docs/skills/catalog.md`) — every skill folder has an entry and vice versa; auto-invoke counts match; slash-command rows reference skills that exist.
