#!/usr/bin/env bash
# Export agent-skills to a single GEMINI.md file for Gemini CLI.
# Gemini CLI auto-loads GEMINI.md as its hierarchical context file.
#
# Usage:
#   ./harnesses/gemini/export.sh <target-project-path> [pack]
...

{
  ...
  printf 'Auto-generated from `pixelcrafts-app/agent-skills`. Do not edit — regenerate via `harnesses/gemini/export.sh`.\n\n'
