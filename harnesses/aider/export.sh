#!/usr/bin/env bash
# Export agent-skills to Aider convention files.
#
# Usage:
#   ./harnesses/aider/export.sh <target-project-path> [pack]
...
conventions="$TARGET/.aider/conventions.md"

{
  printf '# Aider Conventions\n\n'
  printf 'Auto-generated from `pixelcrafts-app/agent-skills`.\n\n'
