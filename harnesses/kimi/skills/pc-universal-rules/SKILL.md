---
name: pc-universal-rules
description: Apply when editing any code file, regardless of stack. Universal rules for security, testing, observability, and engineering. Use on every file edit, code review, or verification pass. Referenced by section — e.g. universal-rules:security, universal-rules:testing.
---
...
These rules apply to every file touched in every task. No scope boundary suppresses them.
